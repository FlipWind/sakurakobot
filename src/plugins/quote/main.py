...
qta = on_alconna(
    Alconna("#qta", Args["nums?", int, 1], meta=CommandMeta(compact=True))
)
...
async def _(
    ...
    await qta.send(Message(MessageSegment.image(f"base64://{encoded_image}")))
